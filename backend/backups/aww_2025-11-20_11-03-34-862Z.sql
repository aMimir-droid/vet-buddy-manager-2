...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Enhanced audit log table untuk tracking perubahan data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_audit_dokter_update` AFTER UPDATE ON `dokter` FOR EACH ROW BEGIN
...
INSERT INTO `kunjungan` VALUES (1,1,1,1,'2025-03-15','09:00:00','Kucing demam dan lemas','Cash',NULL,NULL,NULL),(2,2,4,3,'2025-03-25','11:15:00','Anjing mengalami diare','Cash',NULL,NULL,NULL),(3,1,1,2,'2025-04-05','15:30:00','Rujukan dari kunjungan sebelumnya - kucing masih lemas','Transfer',1,NULL,NULL),(4,2,4,4,'2025-04-15','16:00:00','Rujukan follow-up anjing diare - kondisi memburuk','E-Wallet',2,NULL,NULL),(5,1,2,1,'2025-04-20','10:30:00','Vaksinasi rutin anjing','Transfer',NULL,NULL,'2025-11-20 18:02:14'),(6,1,3,2,'2025-05-10','14:00:00','Pemeriksaan rutin kucing','E-Wallet',NULL,NULL,'2025-11-20 18:02:12'),(7,2,5,3,'2025-07-18','08:45:00','Kelinci tidak mau makan','Transfer',NULL,NULL,'2025-11-20 18:02:11'),(8,3,6,4,'2025-08-20','13:20:00','Sterilisasi kucing betina','Cash',NULL,NULL,'2025-11-20 18:02:08'),(20,1,9,2,'2025-11-20','16:13:00','sdawd','Transfer',NULL,NULL,'2025-11-20 18:02:07'),(21,1,2,2,'2025-11-20','17:02:00',NULL,'Transfer',5,NULL,'2025-11-20 18:02:06'),(22,3,2,5,'2025-11-20','18:03:00',NULL,'Cash',NULL,NULL,NULL);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_audit_kunjungan_insert` AFTER INSERT ON `kunjungan` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_audit_kunjungan_update` AFTER UPDATE ON `kunjungan` FOR EACH ROW BEGIN
    DECLARE v_klinik_id INT;
    DECLARE v_changes TEXT DEFAULT '';
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_audit_kunjungan_delete` AFTER UPDATE ON `kunjungan` FOR EACH ROW BEGIN
    DECLARE v_klinik_id INT;
...
-- Dump completed on 2025-11-20 11:03:35
